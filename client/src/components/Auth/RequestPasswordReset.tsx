      ...
      <div className="space-y-2">
        <div className="relative">
          <input
            ...
            className="peer w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-base text-gray-900 placeholder-transparent transition-all focus:border-green-500 focus:ring-2 focus:ring-green-500/20 focus:outline-none dark:border-gray-700 dark:text-white dark:focus:border-green-500"
