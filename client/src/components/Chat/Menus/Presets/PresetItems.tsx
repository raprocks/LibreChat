                  ...
                  <Flipped flipId={presetId}>
                    ...
                    >
                      <div className="flex h-full items-center justify-end gap-1">
                        ...
                        <button
                          className="m-0 h-full rounded-md p-2 text-gray-400 hover:text-gray-700 sm:invisible sm:group-hover:visible dark:text-gray-400 dark:hover:text-gray-200"
                          onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
                        ...
                        <button
                          className="m-0 h-full rounded-md p-2 text-gray-400 hover:text-gray-600 sm:invisible sm:group-hover:visible dark:text-gray-400 dark:hover:text-gray-200"
                          onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
