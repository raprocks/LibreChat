...
export default function MentionItem({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'text-token-text-primary bg-token-main-surface-secondary group hover:bg-surface-secondary flex h-10 items-center gap-2 rounded-lg px-2 text-sm font-medium',
