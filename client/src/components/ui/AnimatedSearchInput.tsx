      ...
      <div className="relative rounded-lg transition-all duration-500 ease-in-out">
        <div className="relative">
          ...
          <input
            ...
            className={`peer bg-surface-secondary relative z-20 w-full rounded-lg px-10 py-2 ring-0 backdrop-blur-sm transition-all duration-500 ease-in-out outline-none placeholder:text-gray-400 focus:ring-0 focus:outline-none`}
          />
