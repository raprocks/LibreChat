...
const Theme = ({ theme, onChange }: { theme: string; onChange: (value: string) => void }) => {
  ...
  return (
    <button
      className="hover:bg-surface-hover flex items-center gap-2 rounded-lg p-2 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
      aria-label={label}
